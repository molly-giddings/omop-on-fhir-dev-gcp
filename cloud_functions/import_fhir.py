...
def import_fhir(event, context):
    ...
    project = os.environ.get('GCP_PROJECT','MY_PROJECT')    
    queue_name = os.environ.get('TASK_QUEUE', 'import-fhir-queue')
    location = os.environ.get('TASK_QUEUE_LOCATION', 'MY_LOCATION')
    import_function = os.environ.get('FHIR_IMPORT_FUNCTION', 'fhir_to_fhirstore')
